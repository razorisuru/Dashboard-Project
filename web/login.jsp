<%-- 
    Document   : login
    Created on : Mar 11, 2024, 9:37:44 PM
    Author     : iduni
--%>
        ...
        <div class="login-box">
            ...
            <div class="card card-outline card-primary">
                <div class="card-header text-center">
                    <a href="#" class="h1"><b>RaZoR</b>ISURU</a>
                </div>
                <div class="card-body">
                    ...
                    <form action="LogInController" method="post">
                        <div class="input-group mb-3">
                            <input type="email" class="form-control" placeholder="Email" name="email" value="isurubandara318@gmail.com">
